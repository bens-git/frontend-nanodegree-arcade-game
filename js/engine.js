...
var Engine = (function(global) {
    ...
    /*
    This will check if the player hits a bug and reset the players position and score when it happens
    The enemy position needed to be adjusted to the left by 20px for some reason..?
     */
